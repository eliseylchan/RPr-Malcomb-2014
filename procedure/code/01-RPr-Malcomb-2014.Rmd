...
##MODIFICATION: Vulnerability Score by TA
To calculate the climate change vulnerability score for each TA, I took the mean score of all pixels in each TA with an adaptive capacity score. The TA with the lowest vulnerability score is Kasukula (35.9). The TA with the highest vulnerability score is Lundu (73.4).
