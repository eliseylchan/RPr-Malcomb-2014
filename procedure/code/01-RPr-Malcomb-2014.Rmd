...
##MODIFICATION: Vulnerability Score by TA To calculate the climate change vulnerability score for each TA, I took the mean score of all pixels in each TA with an adaptive capacity score.
...
```{r zonal-summary-statistic, eval=FALSE}
